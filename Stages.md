...
* **Advancing stages**
    ...
    * Positive support to advance a stage does **not** imply:
        ...
        * That the particular solution approach at the time of the signal or support will be the one eventually standardized (unless the advancement is to Stage 4 (Standard)).
...
<table>
 ...
 <tbody>
  ...
  <tr id="stage3">
   ...
   <td>
    <ul>
     ...
     <li>A ready-for-review PR has been posted to the relevant WHATWG Living Standard.
    </ul>
   <td>
    <ul>
  ...
  <tr id="stage4">
   ...
   <td>
    <ul>
     <li>The pull request has resulted in a <a href="https://whatwg.org/working-mode#changes">change</a> to a WHATWG Living Standard.
    </ul>
   <td>—
 </tbody>
</table>
